...
munits = {'force': 'meV/Å', 'stress': 'MPa', 'energy': 'meV/atom','virial': 'meV/atom', 'dipole': 'ma.u./atom', 'polarizability': 'ma.u./atom', 'bec' : 'me'}
...
def plot_loss():
    ...
    if os.path.exists('gnep.in'):
        loss = np.loadtxt('loss.out')[:, 1:8]
        label = [r'$L_{\text{total}}$', 'E-train', 'F-train', 'V-train', 'E-test', 'F-test', 'V-test']
